...
public class BoardDao {
	...
	public ArrayList<BoardVo> boardSelectAll(SearchCriteria scri) {
	    ...
	    String sql = "SELECT * FROM BOARD_AWS WHERE delYN = 'N'";
	...
	public int boardTotalCount(SearchCriteria scri) {
		...
		int value = 0;
		// 1. 쿼리 만들기
		String sql = "select count(*) as cnt from BOARD_AWS where delyn='N' " + str + "";
	...
	public int boardInsert(BoardVo bv) {
		...
		String sql = "INSERT INTO BOARD_AWS(originbidx, depth, level_, subject, contents, writer, password, filename, ip) "
				+ "VALUES (null, 0, 0, ?, ?, ?, ?, ?, ?);";
		String sql2 = "UPDATE BOARD_AWS SET originbidx = (SELECT A.maxbidx FROM (SELECT MAX(bidx) AS maxbidx FROM BOARD_AWS)A)"
				+ "WHERE bidx = (SELECT A.maxbidx FROM (SELECT MAX(bidx) AS maxbidx FROM BOARD_AWS)A)";
	...
	public int boardReply(BoardVo bv) {
		...
		String sql2 = "INSERT INTO BOARD_AWS (originbidx, depth, level_, subject, contents, writer, filename, password, ip)"
				+ "VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?);";
